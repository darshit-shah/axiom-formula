! function() {
  ...
  var evaluateAxiomFormula = function(options) {
    this.exec = function() {
        ...
        if (tree.children[childIndex].hasOwnProperty('tree')) {
          ...
          if (tree.children[childIndex].type == "Operation Start") {
            ...
            if (result.children[0].result !== undefined)
              ...
              if (options.rangeValues[result.children[0].part] == undefined) debugger;
    ...
    ***********************************************************/
    ...
    var isFunction = function(value) {
      value = value.toLowerCase();
      if (value.indexOf("sum(") === 0) {
        return true;
      } else if (value.indexOf("min(") === 0) {
        return true;
      } else if (value.indexOf("max(") === 0) {
        return true;
      } else if (value.indexOf("average(") === 0) {
        return true;
      } else if (value.indexOf("if(") === 0) {
        return true;
      } else if (value.indexOf("round(") === 0) {
        return true;
      } else if (value.indexOf("ceiling(") === 0) {
        return true;
      } else if (value.indexOf("floor(") === 0) {
        return true;
      } else if (value.indexOf("getarrayvalues(") === 0) {
        return true;
      } else if (value.indexOf("abs(") === 0) {
        return true;
      } else if (value.indexOf("and(") === 0) {
        return true;
      } else if (value.indexOf("or(") === 0) {
        return true;
      } else if (value.indexOf("concatenate(") === 0) {
        return true;
      } else if (value.indexOf("count(") === 0) {
        return true;
      } else if (value.indexOf("left(") === 0) {
        return true;
      } else if (value.indexOf("right(") === 0) {
        return true;
      } else if (value.indexOf("mid(") === 0) {
        return true;
      } else if (value.indexOf("len(") === 0) {
        return true;
      } else if (value.indexOf("power(") === 0) {
        return true;
      } else if (value.indexOf("sqrt(") === 0) {
        return true;
      } else if (value.indexOf("rand(") === 0) {
        return true;
      } else if (value.indexOf("randbetween(") === 0) {
        return true;
      } else if (value.indexOf("sumproduct(") === 0) {
        return true;
      } else if (value.indexOf("vlookup(") === 0) {
        return true;
      } else if (value.indexOf("dsum(") === 0) {
        return true;
      } else if (value.indexOf("daverage(") === 0) {
        return true;
      } else if (value.indexOf("dcount(") === 0) {
        return true;
      } else if (value.indexOf("dmin(") === 0) {
        return true;
      } else if (value.indexOf("dmax(") === 0) {
        return true;
      } else if (value.indexOf("dproduct(") === 0) {
        return true;
      }
      return false
    }
  ...
  AxiomFormula.evaluateAxiomFormula = function(options) {
    var settings = {
      'formula': undefined,
  ...
  /* Date Function End */
  if (typeof define === "function" && define.amd) this.AxiomFormula = AxiomFormula, define(AxiomFormula);
  else if (typeof module === "object" && module.exports) module.exports = AxiomFormula;
  else this.AxiomFormula = AxiomFormula;
}();
